...
@SpringBootTest// указываем, что этот класс - тестовый, под управлением SpringBoot
@TestInstance(TestInstance.Lifecycle.PER_CLASS)// указываем, что инстанс теста создаётся на весь класс (т.е. для отработки всех методов)
